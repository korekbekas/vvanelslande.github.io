...
| Cycle custom layouts                                                                                                                                                                                                                                                                              | Valentin Vanelslande            | Fre   | [Source code](https://github.com/vvanelslande/vvctre-plugin-cycle-custom-layouts) \| [Windows](https://github.com/vvanelslande/vvctre-plugin-cycle-custom-layouts/releases/download/2.2.0/vvctre-plugin-cycle-custom-layouts-2.2.0-Windows.7z) \| [Linux](https://github.com/vvanelslande/vvctre-plugin-cycle-custom-layouts/releases/download/2.2.0/vvctre-plugin-cycle-custom-layouts-2.2.0-Linux.7z)                                                                                                                         |
