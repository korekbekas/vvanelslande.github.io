...
| Cycle custom layouts                                                                                                                                                                                                                                                                              | Valentin Vanelslande            | Free  | [Source code](https://github.com/vvanelslande/vvctre-plugin-cycle-custom-layouts) \| [Windows](https://github.com/vvanelslande/vvctre-plugin-cycle-custom-layouts/releases/download/3.0.0/vvctre-plugin-cycle-custom-layouts-3.0.0-Windows.7z) \| [Linux](https://github.com/vvanelslande/vvctre-plugin-cycle-custom-layouts/releases/download/3.0.0/vvctre-plugin-cycle-custom-layouts-3.0.0-Linux.7z)                                                                                                                         |
